        ...
        <div className="container-info register">
          <div className="wrap-info">
            <form className="info-form" onSubmit={'continue'}>
              ...
              <div className="wrap-input">
                <input
                  className={values.birthday !== '' ? 'has-val input' : 'input'}
                  type="date"
                  value={values.birthday}
                  onChange={handleChange('birthday')}
                />
                <span
                  className="focus-input focus-input-date"
              ...
              <div className="wrap-input">
                <input
                  className={values.id !== '' ? 'has-val input' : 'input'}
                  type="id"
                  value={values.id}
              ...
              <div className="wrap-input">
                <input
                  className={values.gender !== '' ? 'has-val input' : 'input'}
                  type="gender"
                  value={values.gender}
              ...
              <div className="container-form-btn next">
                <button onClick={this.continue} className="form-btn next-btn">
                  {' '}
                  Próxima Etapa{' '}
                </button>
              </div>
