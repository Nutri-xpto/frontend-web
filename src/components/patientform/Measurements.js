      ...
      <div className="container-info">
        <div className="wrap-info">
          ...
          <div className="wrap-input">
            <input
              className={values.height !== '' ? 'has-val input' : 'input'}
              type="height"
              value={values.height}
          ...
          <div className="wrap-input">
            <input
              className={values.weight !== '' ? 'has-val input' : 'input'}
              type="weight"
              value={values.weight}
          ...
          <div className="wrap-input">
            <input
              className={values.bmi !== '' ? 'has-val input' : 'input'}
              type="bmi"
              value={values.bmi}
          ...
          <div className="wrap-input">
            <input
              className={values.goal !== '' ? 'has-val input' : 'input'}
              type="goal"
              value={values.goal}
          ...
          <div className="wrap-input">
            <input
              className={values.weight_goal !== '' ? 'has-val input' : 'input'}
              type="weight_goal"
            ...
            <span
              ...
              data-placeholder="Meta de Peso"
            ></span>
          </div>

          <div className="wrap-input">
            <input
              className={values.bf !== '' ? 'has-val input' : 'input'}
              type="bf"
              value={values.bf}
            ...
            <span
              className="focus-input"
              data-placeholder="Gordura Corporal (%)"
            ></span>
          </div>
