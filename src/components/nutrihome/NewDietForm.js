...
import { registerDiet } from '../../services/DietServer';
            ...
            <div className="wrap-info">
              <form className="info-form-diet" onSubmit={'continue'}>
                ...
                <div className="wrap-input">
                  <input
                    className={
                      values.patientName !== '' ? 'has-val input' : 'input'
                    }
                    type="patientName"
                  ...
                  <span
                    ...
                    data-placeholder="Nome do Paciente"
                  ></span>
                </div>

                <div className="wrap-input">
                  <input
                    className={values.day !== '' ? 'has-val input' : 'input'}
                    type="day"
                    value={values.day}
                ...
                <div className="wrap-input">
                  <input
                    className={values.time !== '' ? 'has-val input' : 'input'}
                    type="timeoftheday"
                    value={values.time}
                ...
                <div className="wrap-input">
                  ...
                  <span
                    className="focus-input"
                    data-placeholder="Nome da dieta"
                  ></span>
                </div>
                ...
                <div className="wrap-input">
                  <input
                    className={
                      values.ingredients !== '' ? 'has-val input' : 'input'
                    }
                    type="ingredients"
                ...
                <div className="wrap-input">
                  <input
                    className={
                      values.instructions !== '' ? 'has-val input' : 'input'
                    }
                    type="instructions"
                  ...
                  <span
                    className="focus-input"
                    data-placeholder="Modo de Preparo"
                  ></span>
                </div>
              </form>
              <div className="container-form-btn next">
                <button onClick={this.sendData} className="form-btn next-btn">
                  {' '}
                  Cadastrar Dieta{' '}
                </button>
              </div>
